...
THREE.GenericWaterMaterial.prototype._fragmentShader = function () {
	...
	shader.push('if( vPosition.y > '+parseFloat(this._textures[this._textures.length - 1].start+this._textures[this._textures.length - 1].delta).toFixed(2)+' ) { color = color_'+this._textures[this._textures.length - 1].label+'; }');
